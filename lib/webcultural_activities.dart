...
class webcalcuralpage extends StatefulWidget {


  const webcalcuralpage({
    super.key,
 
  });

  @override
  State<webcalcuralpage> createState() => _webcalcuralpageState();
}

class _webcalcuralpageState extends State<webcalcuralpage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Cultural Activities",style: TextStyle(color: Colors.white),),
        centerTitle: true,
      ...
      body: InAppWebView(
  initialUrlRequest: 
  URLRequest(url: WebUri("https://cpsgtinst.org/appcultural.php")),
