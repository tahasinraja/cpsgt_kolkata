...
class webacademy extends StatefulWidget {
  ...
  @override
  State<webacademy> createState() => _webacademyState();
}

class _webacademyState extends State<webacademy> {
  ...
  appBar: AppBar(
      ...
      body: InAppWebView(
  initialUrlRequest: 
  URLRequest(url: WebUri("https://cpsgtinst.org/appacademy.php")),
