...
class webachivepage extends StatefulWidget {
  ...
  @override
  State<webachivepage> createState() => _webachivepageState();
}

class _webachivepageState extends State<webachivepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     appBar: AppBar(
      ...
      body: InAppWebView(
  initialUrlRequest: 
  URLRequest(url: WebUri("https://cpsgtinst.org/apparchive.php")),
